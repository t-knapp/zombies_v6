init()
{
    ...
    [[ level.register ]]( "get_spawnpoint_farthest", ::getSpawnpoint_Farthest, level.iFLAG_RETURN );
    [[ level.register ]]( "get_spawnpoint_nearteam", ::getSpawnpoint_NearTeam, level.iFLAG_RETURN );
    [[ level.register ]]( "get_spawnpoint_semirandom", ::getSpawnpoint_SemiRandom, level.iFLAG_RETURN );
    [[ level.register ]]( "get_spawnpoint_middlethird", ::getSpawnpoint_MiddleThird, level.iFLAG_RETURN );
    [[ level.register ]]( "get_spawnpoint_dm", ::getSpawnpoint_DM, level.iFLAG_RETURN );
}
